...
# Removing in set
set6.pop(); # remove random item
print(set6);

set6.remove("item4"); # remove the specified item, but get you an
                      # error if the element doesnt exist
print(set6);

set6.discard("item2");  # remove the specified item, but doesnt get
                        # you an error if the element doesnt exist
print(set6);

del set6; # delete set, but give you an error if you try to print it
# print(set6);
set6 = {"item4", 3, 8, "item1"};
set6.clear();   # delete set, but doesnt give you an error if you try
                # to print it
print(set6);
"""
